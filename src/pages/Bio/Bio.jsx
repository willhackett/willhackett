  ...
  render() {
    return (
      <Page className="imageblock switchable height-100">
        <Helmet>
          <title>Bio — who am i — Will Hackett</title>
        </Helmet>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-sm-7 contact--types">
              ...
              <p>
                Hi - I'm Will. I spent a lot of time trying to figure out how to make sure this bio doesn't sound like an online dating profile, so we're leaving long walks on the beach and a thousand-star picnic out of it.
              </p>
              <p>
                I'm a software engineer but more specifically a <a href="http://essays.davidchouinard.com/the-product-engineer" target="_blank" rel="noopener noreferrer" title="What the heck is a product engineer?">product engineer</a>. I make products from the ground up&mdash;assess viability, build a roadmap, gather a team, kick goals and deliver a killer end result.
              </p>
              <p>I founded a few startups in my career and have learned lessons important to product development&mdash;<i>"the customer comes first"</i>, <i>"no idea is a dumb idea"</i> and <i>"just get shit done"</i>.</p>
              <p>Beyond building great products I'm a social presence at networking events and nearby gin distilleries. I spend a great deal of time in the gym and make an effort to passively collect as much data related to my workouts as possible&mdash;a mere snapshot is visible on my <Link to="/">homepage</Link>. I enjoy skiing and my favorite time of the year is winter. I've recently adopted a Siberian Husky named Blue.</p>
              ...
              <p>I believe in bridging the gap between for-profit and non-profit organisations and building a sustainable, commercially viable product. <i>Who says you can't make money while making a difference?</i></p>
              ...
              <p>I'm extremely motivated by technology that mitigates the need for complex DevOps chores that slow MVP development. We're already in the future where apps are developed with no servers in the backend&mdash;merely a subscribed Platform as a Service offering.</p>
              ...
              <h3>Coffee order</h3>
              <p>This is a simple one. Before 12 pm, it's a flat white. After 12 pm, it's a chai latte. Pulling a late nighter; I'll go for a dirty chai (chai latte with a shot of espresso).</p>
